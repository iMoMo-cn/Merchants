package com.momo.merchants.recipe.special;

import com.momo.merchants.item.goblet.ItemP2WGoblet;
	...
	public ItemStack getCraftingResult(@Nonnull InventoryCrafting var1) {
		...
		for(int i = 0; i < var1.getSizeInventory(); i++) {
			...
			if(!stack.isEmpty()) {
				...
				//MoMoFramework.Log(stack.getItem().getUnlocalizedName() + " vs " + ItemBlock.getItemFromBlock(Blocks.GOLD_BLOCK).getUnlocalizedName());
			}
		}
