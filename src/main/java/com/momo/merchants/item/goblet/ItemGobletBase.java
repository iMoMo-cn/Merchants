package com.momo.merchants.item.goblet;
...
import static com.momo.merchants.util.IDLNBT.getTagSafe;
import static com.momo.merchants.util.NBTStrDef.IDLNBTDef.*;
import static com.momo.merchants.util.NBTStrDef.IDLNBTDef.P2W_EXP;
...
public class ItemGobletBase extends ItemBase {
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (!worldIn.isRemote)
        {
            ...
            //MoMoFramework.Log(playerXP + " " + getUnlocalizedName(stack));
        }
    }
