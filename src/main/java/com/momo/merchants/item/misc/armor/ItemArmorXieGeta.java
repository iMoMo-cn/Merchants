package com.momo.merchants.item.misc.armor;

import com.momo.merchants.item.IGuaEnhance;
import com.momo.merchants.item.ItemArmorBase;
import com.momo.merchants.util.CommonDef;
...
import static com.momo.merchants.util.NBTStrDef.IDLNBTDef.MODE;
...
public class ItemArmorXieGeta extends ItemArmorBase implements IGuaEnhance {
    ...
    public static void onCreatureHurt(LivingHurtEvent evt) {
        if (evt.isCanceled() || evt.getSource() != DamageSource.FALL) {
            //MoMoFramework.Log("Xie Geta wrong type");
            return;
        }
        ...
        if (onFoot.getItem() instanceof ItemArmorXieGeta)
        {
            ...
            //MoMoFramework.Log("Xie Geta dmg reduction:%s", reduction);
