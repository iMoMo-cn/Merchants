package com.momo.merchants.blocks.Furnitures;
...
public class BlockExtractionDoorTest extends BlockBase {
    ...
    /**
     * Check whether this Block can be placed at pos, while aiming at the specified side of an adjacent blockBush
     */
    ...
    /**
     * Checks if this blockBush can be placed exactly at the given position.
     */
    ...
    /**
     * Called by ItemBlocks just before a blockBush is actually set in the world, to allow for adjustments to the
     * IBlockstate
     */
    ...
    /**
     * Called when a neighboring blockBush was changed and marks that this state should perform any checks during a neighbor
     * change. Cases may include when redstone power is updated, cactus blockBush popping off due to a neighboring solid
     * blockBush, etc.
     */
    ...
    /**
     * Called when the blockBush is right clicked by a player.
     */
    ...
    /**
     * Called serverside after this blockBush is replaced with another in Chunk, but before the Tile Entity is updated
     */
    ...
    /**
     * Can this blockBush provide power. Only wire currently seems to have this change based on its state.
     */
