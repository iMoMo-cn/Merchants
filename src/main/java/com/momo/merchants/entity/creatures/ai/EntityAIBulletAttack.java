...
//        }
    ...
    public void updateTask()
    {
        ...
        {
//            MoMoFramework.LogWarning("cant see");
            this.ticksLookingAtTarget = 0;
        }

//        MoMoFramework.Log(String.format("Looking ticks = %d", ticksLookingAtTarget ));
//        MoMoFramework.Log(String.format("dist = %.2f/%.2f", targetDistance, maxRange));
